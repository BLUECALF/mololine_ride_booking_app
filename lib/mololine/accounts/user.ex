defmodule Mololine.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Mololine.Repo)
  ...
  """
  def valid_password?(%Mololine.Accounts.User{hashed_password: hashed_password}, password)
